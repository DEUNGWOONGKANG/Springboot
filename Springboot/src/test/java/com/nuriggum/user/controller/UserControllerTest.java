...
public class UserControllerTest extends AbstractRestDocs {
    ...
    User getTestData(){
        User user = new User();
        user.setLoginId("nuri1");
        user.setPassword("nur991234!");
    ...
    void changePasswordTest() throws Exception {
        ...
        userManage.setNewPassword1("nuriggum2024!");
        userManage.setNewPassword2("nuriggum2024!");
    ...
    void userFindIdTest() throws Exception {
        User user = new User();
        user.setUserName("누리꿈");
        user.setEmailAddress("nuri@nuriggum.com");
