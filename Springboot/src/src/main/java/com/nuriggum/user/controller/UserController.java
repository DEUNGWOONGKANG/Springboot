...
public class UserController {
	 ...
	 */
	@PutMapping("/{userId}")
	public CommonResult userUpdate(@PathVariable String userId, @RequestBody User user) {
		return responseService.getSingleResult(userService.userUpdate(userId, user));
	}
