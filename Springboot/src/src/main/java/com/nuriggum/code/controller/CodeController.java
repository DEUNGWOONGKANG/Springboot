...
public class CodeController {
    ...
    public CommonResult codeGroupUpdate(@PathVariable String groupId, @RequestBody CodeGroup codeGroup) {
        return responseService.getSingleResult(codeGroupService.codeGroupUpdate(groupId, codeGroup));
    }
